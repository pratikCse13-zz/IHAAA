...
class Liqui {
	constructor(){
		...
		this.redisKeyPersist = redisKeyPersist(constants.STRINGS.liqui)
		this.coinPersist = coinPersist(constants.STRINGS.liqui)
		this.txMakerFee = 0.0025
		this.txTakerFee = 0.0025
		this.depositFee = 0

		this.marketsApi = 'https://api.liqui.io/api/3/info'
		
		this.lastPrice = 'last'
		this.btcVolume = 'vol'
		this.bidPrice = 'buy'
		this.askPrice = 'sell'
		this.marketApiResultSubKey = 'pairs'		
		this.tickerApi = 'https://api.liqui.io/api/3/ticker/||'
		...
		this.orderBookApi = 'https://api.liqui.io/api/3/depth/||?limit='+config.orderBookDepth
